    ...
    public override bool Activate(GameObject target = null)
    {
        ...
        foreach (var tar in targets)
        {
            if(tar.TryGetComponent(out Monster monster))
            {
                ...
                StatusEffectManager.Instance.AddStatusEffect(monster.status, new SlowDown(monster.gameObject, 100f, slowDuration));
                ...
                if(woundEffect != null)
                {
                    ...
                    StatusEffectManager.Instance.AddStatusEffect(monster.status, new SlowDown(monster.gameObject, slowRate, slowDuration));
                }
            }
        }
